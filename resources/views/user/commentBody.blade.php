            ...
            <div class="w-full flex-col justify-start items-start lg:gap-14 gap-4 inline-flex">
                ...
                <form action="{{ route('userStoreComment',['id' => $post->id])}}" method="POST" class="w-full flex-col justify-start items-start gap-5 flex">
                    ...
                    <div class="w-full rounded-3xl justify-start items-start gap-3.5 inline-flex">
                        <img class="w-10 h-10 object-cover rounded-full" src="{{ asset('adminPannel/img/me.jpg') }}" alt="John Smith image" />
                        <textarea name="comment" rows="3" class="w-full px-5 py-3 rounded-2xl border border-gray-300 shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] resize-none focus:outline-none placeholder-gray-400 text-gray-900 text-lg font-normal leading-7" placeholder="Write your thoughts here...."></textarea>
                    </div>
                    <button type="submit" class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 ease-in-out rounded-xl shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
                ...
                <div class="w-full flex-col justify-start items-start gap-8 flex">
                    ...
                    <div class="w-full pb-6 border-b border-gray-300 justify-start items-start gap-2.5 inline-flex">
                        <img class="w-10 h-10 rounded-full object-cover" src="{{ asset('adminPannel/img/me.jpg') }}" alt="Mia Thompson image" />
                        <div class="w-full flex-col justify-start items-start gap-3.5 inline-flex">
                            <div class="w-full justify-start items-start flex-col flex gap-1">
                                <div class="w-full justify-between items-start gap-1 inline-flex">
                                    <h5 class="text-gray-900 text-sm font-semibold leading-snug">{{ $comment->user_name }}</h5>
